...
admin-change-role-user = Изменить роль
admin-change-role-user-select = Выберите новую роль.
admin-change-role-user-select-list = Выберите пользователя из списка ниже.
admin-change-role-successful = Пользователю { $username } была предоставлена новая роль - { $role }.
